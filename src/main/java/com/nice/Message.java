...
public class Message extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Message\",\"namespace\":\"com.nice\",\"fields\":[{\"name\":\"to\",\"type\":\"string\"},{\"name\":\"from\",\"type\":\"string\"},{\"name\":\"body\",\"type\":\"string\"}]}");
  ...
  public static com.nice.Message.Builder newBuilder() {
    return new com.nice.Message.Builder();
  }
  
  /** Creates a new Message RecordBuilder by copying an existing Builder */
  public static com.nice.Message.Builder newBuilder(com.nice.Message.Builder other) {
    return new com.nice.Message.Builder(other);
  }
  
  /** Creates a new Message RecordBuilder by copying an existing Message instance */
  public static com.nice.Message.Builder newBuilder(com.nice.Message other) {
    return new com.nice.Message.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Message>
    ...
    private Builder() {
      super(com.nice.Message.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.nice.Message.Builder other) {
      super(other);
    ...
    private Builder(com.nice.Message other) {
            super(com.nice.Message.SCHEMA$);
      if (isValidValue(fields()[0], other.to)) {
        this.to = data().deepCopy(fields()[0].schema(), other.to);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'to' field */
    public com.nice.Message.Builder setTo(java.lang.CharSequence value) {
    ...
    public com.nice.Message.Builder clearTo() {
      to = null;
    ...
    /** Sets the value of the 'from' field */
    public com.nice.Message.Builder setFrom(java.lang.CharSequence value) {
    ...
    public com.nice.Message.Builder clearFrom() {
      from = null;
    ...
    /** Sets the value of the 'body' field */
    public com.nice.Message.Builder setBody(java.lang.CharSequence value) {
    ...
    public com.nice.Message.Builder clearBody() {
      body = null;
